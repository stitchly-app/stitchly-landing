import { Video, Settings, BarChart3, FolderOpen, User, LogOut } from "lucide-react";
...
export const DashboardSidebar = () => {
  ...
  const menuItems = [
    { title: "Dashboard", path: "/dashboard", icon: FolderOpen },
    { title: "Projects & Reports", path: "/projects-reports", icon: BarChart3 },
              ...
              <button className="flex items-center gap-3 w-full text-left hover:bg-sidebar-accent/50 rounded-lg p-2 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-sidebar-foreground truncate">
                    {profile?.name || user?.user_metadata?.first_name || user?.user_metadata?.name || "User"}
                  </p>
